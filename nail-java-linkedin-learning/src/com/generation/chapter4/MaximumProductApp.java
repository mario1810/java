...
public class MaximumProductApp {
    ...
    public static int maximumProduct3(int[] arr) {
	  ...
	  public static void main(String[] args) {
	        ...
	        System.out.println(maximumProductM(t1));
	        System.out.println(maximumProductM(t2));
	        System.out.println(maximumProductM(t3));
	...
	private static int maximumProductM(int[] t) {
